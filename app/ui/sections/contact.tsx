...
export const Contact = () => {
  ...
  useEffect(() => {
    ...
    console.log(
      `%cAbdrahman Oladimeji - Crafting digital experiences that spark connection and leave a mark.`,
      "font-weight: bold; font-size: 1.1em; color: #2196f3;",
    );
    console.log(
      "%cPsst... curious about the inner workings? Open the 'Elements' and 'Console' tabs in your developer tools for a peek behind the scenes! 😉",
      "color: #00bcd4; font-style: italic;",
    );

    setTimeout(() => {
      console.log(
        "%c🚀 Welcome to my portfolio! Feel free to dive into the code and see the magic happen. Let's build something amazing together!",
